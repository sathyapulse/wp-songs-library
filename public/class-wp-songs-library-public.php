 ...
 * @subpackage Wp_Songs_Library/public
 */
...
class Wp_Songs_Library_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Wp_Songs_Library_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Wp_Songs_Library_Loader will then create the relationship
